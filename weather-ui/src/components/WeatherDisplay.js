        ...
        return (
          <div className="weather-display">
            <div className="weather-column">
              <p>{"City: " + this.props.forecast.name}</p>
              <p>{"Temp: " + this.props.forecast.main.temp + " °F"}</p>
              <p>{"High: " + this.props.forecast.main.temp_max + " °F"}</p>
              <p>{"Low: " + this.props.forecast.main.temp_min + " °F"}</p>
            </div>
            <div className="weather-column">
              <p>
                {"Description: " +
              ...
              <p>{"Pressure: " + this.props.forecast.main.pressure + " hpa"}</p>
              <p>{"Wind Speed: " + this.props.forecast.wind.speed + " m/h"}</p>
            </div>
